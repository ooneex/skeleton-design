...
type SidebarMenuActionPropsType = useRender.ComponentProps<"button"> &
  React.ComponentProps<"button"> & {
    showOnHover?: boolean;
  };

export const SidebarMenuAction = ({ className, render, showOnHover = false, ...props }: SidebarMenuActionPropsType) => {
  return useRender({

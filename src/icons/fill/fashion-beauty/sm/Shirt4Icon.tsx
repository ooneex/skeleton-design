  ...
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19 3C20.6569 3 22 4.34315 22 6V19C22 20.6569 20.6569 22 19 22H13V10.5654L15.1709 12.4951C15.537 12.8205 16.0102 13 16.5 13H17C18.1046 13 19 12.1046 19 11V3Z"
        fill="currentColor"
      />
      <path

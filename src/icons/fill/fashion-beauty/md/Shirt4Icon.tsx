...
export const Shirt4Icon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M26 4C28.2091 4 30 5.79086 30 8V26C30 28.2091 28.2091 30 26 30H17V13.4854L20.3271 14.8506C20.5679 14.9493 20.8257 15 21.0859 15H23C24.1046 15 25 14.1046 25 13V4H26Z"
        fill="currentColor"
      />
    </svg>
  );

  ...
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        ...
        data-color="color-2"
      />
      <path fillRule="evenodd" clipRule="evenodd" d="M44 16.5H22V19.5H44V16.5Z" fill="currentColor" />
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M44 28.5H22V31.5H44V28.5Z" fill="currentColor" />
    </svg>
  );
};

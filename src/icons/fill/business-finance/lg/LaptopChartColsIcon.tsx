...
export const LaptopChartColsIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M21 30V13H27V30H21Z" fill="currentColor" data-color="color-2" />
      <path d="M31 30V18H37V30H31Z" fill="currentColor" data-color="color-2" />
      <path d="M11 30V24H17V30H11Z" fill="currentColor" data-color="color-2" />
    </svg>
  );
};

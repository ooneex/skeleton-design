...
export const LaptopChartPieIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M24 30C28.6944 30 32.5 26.1944 32.5 21.5H24V13C19.3056 13 15.5 16.8056 15.5 21.5C15.5 26.1944 19.3056 30 24 30Z"
        fill="currentColor"
        data-color="color-2"
      />
    </svg>

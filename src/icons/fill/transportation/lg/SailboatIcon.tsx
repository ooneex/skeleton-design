  ...
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M40.8402 24.0864C42.5574 23.9948 44 25.3625 44 27.0821V31.5H41V27.0821L30 27.6689V32H27V27.6689C27 26.0741 28.2477 24.7581 29.8402 24.6731L40.8402 24.0864Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"

  ...
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15 3H20C21.6569 3 23 4.34315 23 6C23 7.35859 22.0977 8.50383 20.8619 8.87408L19.904 9.16107L19.33 7.24521L20.2879 6.95821C20.7008 6.8345 21 6.45089 21 6C21 5.44772 20.5523 5 20 5H15V3Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"

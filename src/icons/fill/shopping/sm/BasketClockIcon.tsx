...
export const BasketClockIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M18 11C14.691 11 12 13.691 12 17C12 20.309 14.691 23 18 23C21.309 23 24 20.309 24 17C24 13.691 21.309 11 18 11ZM20 20.414L17 17.414V13.5H19V16.586L21.414 19L20 20.414Z"
        fill="currentColor"
        data-color="color-2"
      />
      <path

...
export const CameraFocus4Icon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M15 9H17V23H15V9Z" fill="currentColor" data-color="color-2" />
      <path
        d="M23.0001 14.9933L23.0001 16.9933L9.00006 16.9933L9.00006 14.9933L23.0001 14.9933Z"
        fill="currentColor"
        data-color="color-2"
      />

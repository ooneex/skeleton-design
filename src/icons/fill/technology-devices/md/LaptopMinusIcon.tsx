  ...
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M23 18.5C27.1421 18.5 30.5 15.1421 30.5 11C30.5 6.85786 27.1421 3.5 23 3.5C18.8579 3.5 15.5 6.85786 15.5 11C15.5 15.1421 18.8579 18.5 23 18.5ZM19 10V12H27V10H19Z"
        fill="currentColor"
        data-color="color-2"
      />
      <path

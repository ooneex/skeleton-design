  ...
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M43.5 36C43.5 41.2467 39.2467 45.5 34 45.5C28.7533 45.5 24.5 41.2467 24.5 36C24.5 30.7533 28.7533 26.5 34 26.5C39.2467 26.5 43.5 30.7533 43.5 36ZM35.5 36.3787L37.6449 34.2338L39.7662 36.3551L34.0001 42.1213L28.2306 36.3518L30.352 34.2305L32.5 36.3786V31H35.5V36.3787Z"
        fill="currentColor"
        data-color="color-2"
      />
    </svg>

...
export const MobileCameraIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M29.5 7C30.3284 7 31 7.67157 31 8.5C31 9.32843 30.3284 10 29.5 10C28.6716 10 28 9.32843 28 8.5C28 7.67158 28.6716 7 29.5 7Z"
        fill="currentColor"
        data-color="color-2"
      />
      <path
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M20 8.5C20 7.67157 20.6716 7 21.5 7L25.5 7C26.3284 7 27 7.67157 27 8.5C27 9.32843 26.3284 10 25.5 10L21.5 10C20.6716 10 20 9.32843 20 8.5Z"
        fill="currentColor"
      />
    </svg>
  );

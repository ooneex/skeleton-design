...
export const HeadphonesWirelessIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M12.4645 13.5355C14.4171 11.5829 17.5829 11.5829 19.5355 13.5355"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"
      ...
      />
      <path
        d="M16.7071 16.364C16.3166 15.9734 15.6834 15.9734 15.2929 16.364L16 17.071L16.7071 16.364Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"

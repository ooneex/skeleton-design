...
export const NetworkNodesIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M4.5 13.5L10.5 19.5" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path d="M4.5 10.5L10.5 4.5" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path d="M19.5 13.5L13.5 19.5" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path d="M19.5 10.5L13.5 4.5" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path

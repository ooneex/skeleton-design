...
export const GasPumpIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M6 37L36 37" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path
      ...
      <path
        ...
        fill="none"
      />
      <path d="M18.4758 10.5L19.6319 15.4331" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path

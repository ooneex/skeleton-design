...
export const FahrenheitIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M19 43V12H38" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path d="M19 26H32" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path

...
export const FileLockIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <path
        d="M20 17H13C12.4477 17 12 17.4477 12 18V21C12 21.5523 12.4477 22 13 22H20C20.5523 22 21 21.5523 21 21V18C21 17.4477 20.5523 17 20 17Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"
      ...
      />
      <path
        d="M14 17V14.5C14 13.119 15.119 12 16.5 12C17.881 12 19 13.119 19 14.5V17"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"

...
export const BrightnessIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M24 11V37" stroke="currentColor" strokeWidth="2" data-cap="butt" fill="none" />
      <path
        ...
        fill="none"
      />
      <path d="M24 2V5" stroke="currentColor" strokeWidth="2" strokeLinecap="square" data-color="color-2" fill="none" />
      <path
        d="M24 43V46"
        stroke="currentColor"
        strokeWidth="2"

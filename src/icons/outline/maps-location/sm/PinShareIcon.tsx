...
export const PinShareIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M12 22C12 22 4.5 15.5 4.5 9.75768C4.5 4.81181 8.34409 2 12 2C15.5637 2 19.3063 4.6718 19.4927 9.38766"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
      ...
      />
      <path
        d="M15.5 19.5C16.3284 19.5 17 18.8284 17 18C17 17.1716 16.3284 16.5 15.5 16.5C14.6716 16.5 14 17.1716 14 18C14 18.8284 14.6716 19.5 15.5 19.5Z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
      ...
      />
      <path
        d="M16.7939 17.2449L20.2089 15.2529"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        data-color="color-2"
      ...
      />
      <path
        d="M16.7939 18.7549L20.2089 20.7469"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        data-color="color-2"

  ...
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        ...
        fill="none"
      />
      <path d="M7 28H24" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path d="M24 3V45" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path

...
export const Wardrobe4Icon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M5 22H16" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
      <path d="M5 14H16" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />

...
export const Bus2Icon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M5 28H13.02V30C13.02 31.6569 11.6769 33 10.02 33H5"
        stroke="currentColor"
        strokeWidth="2"
      ...
      />
      <path
        d="M43.02 28H35V30C35 31.6569 36.3431 33 38 33H43.02"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"
        fill="none"
      />
      <path d="M24 5V22" stroke="currentColor" strokeWidth="2" data-color="color-2" data-cap="butt" fill="none" />

  ...
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <circle
        ...
        cy="1.5"
        r="1.5"
        transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 30 11)"
        fill="currentColor"
        data-stroke="none"
        data-cap="butt"
      />
      <circle
        ...
        data-cap="butt"
      />
      <circle cx="9.75" cy="3.5" r="1.5" fill="currentColor" data-stroke="none" data-cap="butt" />
      <path
      ...
      <circle
        ...
        cy="22.25"
        r="1.5"
        transform="rotate(90 28.5 22.25)"
        fill="currentColor"
        data-stroke="none"
        data-cap="butt"
      />
      ...
      <circle
        ...
        cy="28.5"
        r="1.5"
        transform="rotate(-180 22.25 28.5)"
        fill="currentColor"
        data-stroke="none"
        data-cap="butt"
      />
      <path
        ...
        data-cap="butt"
      />
      <circle cx="22.25" cy="3.5" r="1.5" fill="currentColor" data-stroke="none" data-cap="butt" />
      <circle cx="28.5" cy="3.5" r="1.5" fill="currentColor" data-stroke="none" data-cap="butt" />
    </svg>
  );
};

...
export const FilePyIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M5.5 22V15H8C9.38071 15 10.5 16.1193 10.5 17.5V17.5C10.5 18.8807 9.38071 20 8 20H6"
        stroke="currentColor"
        strokeWidth="2"
      ...
      />
      <path
        d="M16 19V22M16 19L13.5 15H13.5625M16 19L18.5 15H18.4455"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"

...
export const FileCgiIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M20 3V16H7" stroke="currentColor" strokeWidth="2" strokeMiterlimit="10" data-cap="butt" fill="none" />
      <path
        d="M30 37H33.0002V43H29.1629C25.2072 43 22 39.866 22 36C22 32.134 25.2072 29 29.1629 29H29.9304"
        stroke="currentColor"
        strokeWidth="2"
      ...
      />
      <path
        d="M17 30.1004C15.9897 29.4038 14.7886 29 13.5 29C9.91015 29 7 32.134 7 36C7 39.866 9.91015 43 13.5 43C14.7886 43 15.9897 42.5962 17 41.8996"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"

...
export const FileSvgIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <path
        d="M29.8523 29H30L25.2857 43H23.7143L19 29H19.1607"
        stroke="currentColor"
        strokeWidth="2"
      ...
      />
      <path
        d="M41 37H44.0002V43H40.1629C36.2072 43 33 39.866 33 36C33 32.134 36.2072 29 40.1629 29H41"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"
      ...
      />
      <path
        d="M14 29H8.5C6.567 29 5 30.567 5 32.5V32.5C5 34.433 6.567 36 8.5 36H12.5C14.433 36 16 37.567 16 39.5V39.5C16 41.433 14.433 43 12.5 43H7"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"

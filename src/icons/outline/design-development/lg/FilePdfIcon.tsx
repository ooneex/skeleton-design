...
export const FilePdfIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      <path
        d="M7 43V29H11.3333C13.9107 29 16 31.0893 16 33.6667V33.6667C16 36.244 13.9107 38.3333 11.3333 38.3333H7.5"
        stroke="currentColor"
        strokeWidth="2"
      ...
      />
      <path
        d="M20 29V43H23.5C27.366 43 30.5 39.866 30.5 36C30.5 32.134 27.366 29 23.5 29H20Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        data-color="color-2"

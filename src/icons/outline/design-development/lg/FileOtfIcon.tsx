...
export const FileOtfIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path d="M20 3V16H7" stroke="currentColor" strokeWidth="2" strokeMiterlimit="10" data-cap="butt" fill="none" />
      <path
        d="M17 36C17 39.866 14.3137 43 11 43C7.68629 43 5 39.866 5 36C5 32.134 7.68629 29 11 29C14.3137 29 17 32.134 17 36Z"
        stroke="currentColor"
        strokeWidth="2"
        data-color="color-2"
        data-cap="butt"
      ...
      />
      <path
        d="M25 43V29M25 29H30M25 29L20 29"
        stroke="currentColor"
        strokeWidth="2"

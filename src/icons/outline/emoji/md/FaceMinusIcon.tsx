...
export const FaceMinusIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M16 24C12.829 24 10.1504 21.8915 9.28988 19"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
      ...
      />
      <path
        d="M18 29.8582C17.3468 29.9517 16.679 30 16 30C8.26801 30 2 23.732 2 16C2 8.26801 8.26801 2 16 2C23.732 2 30 8.26801 30 16C30 17.0297 29.8888 18.0335 29.6778 19"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"

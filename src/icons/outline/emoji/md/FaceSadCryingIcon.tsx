...
export const FaceSadCryingIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M21 18.5C21.9089 19.3333 22.75 20.5833 22.75 21.6571C22.75 22.7899 21.9664 23.5 21 23.5C20.0336 23.5 19.25 22.7899 19.25 21.6571C19.25 20.5833 20.1004 19.3333 21 18.5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
      ...
      />
      <path
        d="M16 18C12.829 18 10.1504 20.1085 9.28989 23"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"

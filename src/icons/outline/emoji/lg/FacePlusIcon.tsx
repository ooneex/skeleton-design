...
export const FacePlusIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      <path
        d="M13.1814 27C14.0027 31.4717 17.5283 34.9972 22 35.8186"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
      ...
      />
      <path
        d="M25 44.9766C24.6686 44.9921 24.3352 45 24 45C12.402 45 3 35.598 3 24C3 12.402 12.402 3 24 3C35.598 3 45 12.402 45 24C45 24.3352 44.9921 24.6686 44.9766 25"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="square"

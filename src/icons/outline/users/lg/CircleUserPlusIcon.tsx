...
export const CircleUserPlusIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M27 3.21267C26.0202 3.07252 25.0186 3 24 3C12.402 3 3 12.402 3 24C3 35.598 12.402 45 24 45C35.598 45 45 35.598 45 24C45 22.9814 44.9275 21.9798 44.7873 21"
        stroke="currentColor"
        strokeWidth="2"
        strokeMiterlimit="10"

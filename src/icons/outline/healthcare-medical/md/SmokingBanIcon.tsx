...
export const SmokingBanIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M19.5 25H27C28.1046 25 29 24.1046 29 23V21C29 19.8954 28.1046 19 27 19H15.5"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        fill="none"
      ...
      <path
        ...
        fill="none"
      />
      <path d="M10 25H3L3 19H6" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
    </svg>
  );
};

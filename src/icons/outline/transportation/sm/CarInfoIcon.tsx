...
export const CarInfoIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg height="16" width="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <path
        d="M12 6H7.48806C6.60484 6 5.8262 6.57934 5.57241 7.4253L4.5 11L3.25722 11.4971C2.4979 11.8008 2 12.5363 2 13.3541V20C2 20.5523 2.44772 21 3 21H5C5.55228 21 6 20.5523 6 20V19H18V20C18 20.5523 18.4477 21 19 21H21C21.5523 21 22 20.5523 22 20V13.3463C22 12.9694 21.8937 12.6102 21.7044 12.3031"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="square"
        fill="none"
      />
      <path d="M23.01 9H23" stroke="currentColor" strokeWidth="2" strokeLinecap="square" fill="none" />
    </svg>
  );
};
